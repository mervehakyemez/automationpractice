...
This project is an example of UI automated functional test for Give an order example from http://automationpractice.com/ using Selenium and Cucumber.
...
- _login:_ mervehakyemezz@gmail.com
- _password:_ merve123
